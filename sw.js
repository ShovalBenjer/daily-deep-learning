...
const FRESH = ['/posts/', '/units/', 'judgment_map.json', 'research_ladder.json', 'talents.json', 'corpus_manifest.json', 'concepts.json', 'discoveries.json', 'skills.json', 'curriculum.json', 'goals.json'];
