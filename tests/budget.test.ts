...
//: The one inline <script> that is the entire client. 173024 bytes measured
//: 2026-08-30 after 10 interactive widgets (+stack-parens, heap-topk,
//: bst-search, list-reverse). Raising is allowed, silently drifting is not.
